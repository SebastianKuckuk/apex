...
#pragma acc enter data copyin(a [0:nx * ny])
#pragma acc enter data copyin(b [0:nx * ny])
#pragma acc enter data copyin(c [0:nx * ny])
...
#pragma acc exit data copyout(a [0:nx * ny])
#pragma acc exit data copyout(b [0:nx * ny])
#pragma acc exit data copyout(c [0:nx * ny])
