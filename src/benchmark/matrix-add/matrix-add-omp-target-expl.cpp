...
#pragma omp target enter data map(to : b [0:nx * ny])
#pragma omp target enter data map(to : c [0:nx * ny])
...
#pragma omp target exit data map(from : a [0:nx * ny])
#pragma omp target exit data map(from : b [0:nx * ny])
#pragma omp target exit data map(from : c [0:nx * ny])
